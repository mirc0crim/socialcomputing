...
<meta property="og:image" content=""/>
   <style type="text/css">
            ...
            body								{ background-color: #F00000; color: #005e86;   font-family:georgia,Arial;    font-size: 14px;}
                ...
                <div id="main">
                    <div class="borders">
                        <div class="picture" title="serversfree.com">
                            <div id="free-hosting">
                                <h1><span class="ok">YO!! Maxx!!</span> Your website <strong><? print $host; ?></strong> is running successfully on ServersFree.com free hosting servers!</h1>
